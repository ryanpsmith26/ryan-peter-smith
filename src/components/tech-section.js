    ...
    <div id="tech">
        ...
        <div className={styles.card} id="tech">
            ...
            >
                ...
                />
                <img
                    src={require('../images/styled-components.svg')}
                ...
                />
                <img
                    src={require('../images/firebase.svg')}
                    alt="Firebase Logo"
                    className={styles.techLogoMd}
                />
                <img
                    src={require('../images/aws-lambda-1.svg')}
                    alt="AWS Lambdas Logo"
                    className={styles.techLogoSm}
                />
                <img
                    src={require('../images/storybook.svg')}
                    alt="Storybook Logo"
                    className={styles.techLogoXs}
                />
                <img
                    src={require('../images/vercel.svg')}
                    alt="Vercel Logo"
                    className={styles.techLogoXs}
                />
            </Marquee>
