		...
		<div id="tech">
			...
			<div className={styles.card} id="tech">
				...
				>
						...
						<img src={require('../images/nodejs.svg')} alt="Node.js Logo" className={styles.techLogoLg} />
						<img src={require('../images/react4.svg')} alt="React Logo" className={styles.techLogoMd} />
